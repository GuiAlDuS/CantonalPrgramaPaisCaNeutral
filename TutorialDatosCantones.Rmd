...
tablaGeneralIni %>% 
  ...
  filter(sumTot != 0)
```
Notese que existen varios sectores específicos con cero emisiones en los tres alcances. De un total de 22 sectores específicos pasamos a 14 con emisiones.

Para la claridad de los gráficos, eliminamos esos sectores específicos sin emisiones en ninguno de los alcances.
