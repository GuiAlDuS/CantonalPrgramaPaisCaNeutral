...
La mayor parte del análisis se realizará utilizando los paquetes del Tidyverse.
...
```{r}
tablaGeneral %>% group_by(Sector, Esp) %>% summarise() %>% group_by(Sector) %>% summarise(n())
```
